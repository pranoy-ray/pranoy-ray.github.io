...
{% include figure.liquid path="assets/img/voxmol.gif" title="Voxelized Molecules" class="img-fluid rounded z-depth-1" %}
<div class="caption">Actual input: Voxelized BCC SQS structure</div>
